...
class SampleForm(forms.Form):
    element1=forms.ElementType(arguments)
    element2=forms.ElementType(arguments)
    element3=forms.ElementType(arguments)
"""
...
class SampleForm(forms.Form):
    First_Name=forms.CharField(max_length=20,required=True,label="First Name",help_text="Note:Space and Special characters are not allowed")
    ...
    #phno=forms.RegexField(max_length=10,min_value=10,required=True,regex=r'[6-9]\d{9}')
